...
- [object](https://github.com/ipfs/interface-ipfs-core/tree/master/API/object): new(), stat()

Not implemented yet:

- [dag](https://github.com/ipfs/interface-ipfs-core/tree/master/API/dag): get(), put()
- [object](https://github.com/ipfs/interface-ipfs-core/tree/master/API/object): put(), get(), data(), links(), patch.addLink(), patch.rmLink(), patch.appendData(), patch.setData()
